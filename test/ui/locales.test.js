...
const UNTRANSLATED_BACKLOG = {
  ...
  // Spanish and Italian arrived after the Denmark map layers did, and neither translation has
  // caught up to them - same gap as Turkish above, not a regression in either.
  'es.json': [
    'map.filterTaxLayer',
    'map.filterSchoolLayer',
    'map.filterSchoolLayerUnavailable',
